...
[![Basic CSS syntax](https://cdn.statically.io/gh/TheOdinProject/curriculum/05ce472eabf8e04eeb2cc9139e66db884074fd7d/foundations/html_css/css-foundations/imgs/00.jpg)](https://cdn.statically.io/gh/TheOdinProject/curriculum/05ce472eabf8e04eeb2cc9139e66db884074fd7d/foundations/html_css/css-foundations/imgs/00.jpg)
...
### [Knowledge check](https://www.theodinproject.com/lessons/foundations-intro-to-css#knowledge-check)

This section contains questions for you to check your understanding of this lesson on your own. If you’re having trouble answering a question, click it and review the material it links to.

- [What is the syntax for class and ID selectors?](https://www.theodinproject.com/lessons/foundations-intro-to-css#class-selectors)
- [How would you apply a single rule to two different selectors?](https://www.theodinproject.com/lessons/foundations-intro-to-css#the-grouping-selector)
- [Given an element that has an id of `title` and a class of `primary`, how would you use both attributes for a single rule?](https://www.theodinproject.com/lessons/foundations-intro-to-css#chaining-selectors)
- [What does the descendant combinator do?](https://www.theodinproject.com/lessons/foundations-intro-to-css#descendant-combinator-description)
- [What are the names of the three ways to add CSS to HTML?](https://www.theodinproject.com/lessons/foundations-intro-to-css#adding-css-to-html)
- [What are the main differences between the three ways of adding CSS to HTML?](https://www.theodinproject.com/lessons/foundations-intro-to-css#external-css)

### [Additional resources](https://www.theodinproject.com/lessons/foundations-intro-to-css#additional-resources)
