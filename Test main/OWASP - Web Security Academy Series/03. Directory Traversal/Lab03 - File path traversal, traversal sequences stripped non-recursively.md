arget Goal - Retrieve the contents of the /etc/passwd file.
...
RUN:
```bash
	python3 directory-traversal-lab-03.py 'https://0a9c00f3434k5cb0ae7fae87efa80.web-security-academy.net'
```